        ...
        >
          <div className="row" style={{ gap: 12 }}>
            ...
            <div className="flex-1">
              <div style={{ fontSize: 16, fontWeight: 700 }}>织梦 · 设计师App</div>
              <div style={{ fontSize: 11.5, opacity: .78, marginTop: 3 }}>独立创作工具 · 2D画布 / 素材库 / 3D模拟 / 工艺单（新窗口打开）</div>
            </div>
            <span className="row" style={{ gap: 2, fontSize: 11, background: 'rgba(255,255,255,.18)', padding: '3px 9px', borderRadius: 99 }}>
              <Icon name="link" size={12} />打开
            </span>
          </div>
          <div className="row" style={{ marginTop: 12, gap: 6 }}>
            {['人体模板起稿', '面料/图案素材', '3D 试衣验证', '工艺单上线'].map((t) => (
