...
import { BG_SCENES, img } from '../../data/mock';
...
/* 自定义场景可选背景图（/images/bg-*.jpg） */
const CUSTOM_BGS = [1, 2, 3, 4, 5].map((n) => img(`bg-0${n}.jpg`));
...
export default function TryonPage() {
  ...
  const pickScene = (i: number) => {
    setSceneIdx(i);
    toast(`已切换到「${BG_SCENES[i].name}」场景`);
  };
